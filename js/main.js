...
var duoshuoName = "qi3ip"; // change to your DUOSHUO name
var duoshuoQuery = {short_name: "qi3ip"}; // change to your duoshuo name
function toggleDuoshuoComments(container) {
    ...
    el.setAttribute('data-author-key', "qi3ip"); // change to your duoshuo name
